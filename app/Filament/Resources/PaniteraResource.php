...
use App\Filament\Resources\PaniteraResource\Pages;
...
class PaniteraResource extends Resource
{
        ...
        return $form
            ->schema([
                ...
                TextInput::make('jabatan')
                    ->label('Jabatan / Majelis')
                    ->placeholder('Contoh: Panitera Majelis 1 / Bidang MSQ')
                    ->maxLength(255),
    ...
    {
        $query = parent::getEloquentQuery()->where('role', Official::ROLE_PANITERA);
    ...
    {
        return [
            'index' => Pages\ManagePaniteras::route('/'),
        ];
    }
}
