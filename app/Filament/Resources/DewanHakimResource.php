...
use App\Filament\Resources\DewanHakimResource\Pages;
...
class DewanHakimResource extends Resource
{
        ...
        return $form
            ->schema([
                TextInput::make('nama')
                    ...
                    ->required()
                    ->placeholder('Contoh: DR. H. MUHAMMAD RIDWAN, M.Ag')
                    ->maxLength(255),

                TextInput::make('jabatan')
                    ->label('Jabatan / Bidang')
                    ->placeholder('Contoh: Ketua Dewan Hakim / Hakim Bidang Tilawah')
                    ->maxLength(255),
    ...
    {
        $query = parent::getEloquentQuery()->where('role', Official::ROLE_DEWAN_HAKIM);
    ...
    {
        return [
            'index' => Pages\ManageDewanHakims::route('/'),
        ];
    }
}
