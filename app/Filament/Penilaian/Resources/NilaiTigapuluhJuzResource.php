...
class NilaiTigapuluhJuzResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'MHQ 30 Juz';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                HasLiveScoreActions::getTimerTableColumn('tigapuluhjuz'),
            ])
            ...
            ->headerActions([
                ...
                //         ]),
                //     ])
                Action::make('viewNilaiTigapuluhjuz')
                    ->label('Penilaian Tiga Puluh Juz')
                    ->url(route('nilai-tigapuluhjuz.index'))
                    ->icon('heroicon-o-eye')
                    ->openUrlInNewTab(),
            ])
            ->actions([
                ...
                ...HasLiveScoreActions::getLiveScoreTableActions('tigapuluhjuz'),
            ])
            ->recordClasses(HasLiveScoreActions::getRecordClasses('tigapuluhjuz'))
            ->bulkActions([
